...
with Continuous(
    ...
    ], instructions="Use stable example data for each Simulator.", model="gpt-6-astra", timeout_seconds=14400)
...
| `builder`                                                                                                                                                                                                                                                                   | [Optional[models.BuildWorldRequestBuilder]](../../models/buildworldrequestbuilder.md)                                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                                                                                                                          | Legacy provider selection. Alone it selects the provider's default model (openai is gpt-6-astra, claude is claude-fable-5-1); with model it must name the model's provider.                                                                                                 |
